...
export class CustomLabelFactory extends AbstractLabelFactory<DefaultLabelModel> {
	constructor(private resolver: ComponentFactoryResolver, private renderer: Renderer2) {
		super('custom-label');
	}

	generateWidget(label: CustomLabelComponent, labelHost: ViewContainerRef): ComponentRef<CustomLabelComponent> {
